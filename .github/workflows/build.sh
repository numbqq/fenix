...
do
	...
	do
		...
		BUILD_TYPE=release COMPRESS_IMAGE=yes NO_CCACHE=yes INSTALL_TYPE_RAW=yes make || BUILD_TYPE=release COMPRESS_IMAGE=yes NO_CCACHE=yes INSTALL_TYPE_RAW=yes make
